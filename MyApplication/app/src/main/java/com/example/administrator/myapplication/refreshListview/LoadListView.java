...
//        header = inflater.inflate(R.layout.reflash_list, null);
...
//
//        footer = inflater.inflate(R.layout.load_list, null);
...
//        RotateAnimation anim = new RotateAnimation(0, 180, RotateAnimation.RELATIVE_TO_SELF, 0.5f, RotateAnimation.RELATIVE_TO_SELF, 0.5f);//旋转动画
...
////                progress.startAnimation(rotate_infinite);
//                tip.setText("正在刷新...");
//                arrow.clearAnimation();
//                break;
//        }
...
//    }
    ...
    private void init(Context context){
        ...
        mFootView= LayoutInflater.from(context).inflate(R.layout.load_list,null);
