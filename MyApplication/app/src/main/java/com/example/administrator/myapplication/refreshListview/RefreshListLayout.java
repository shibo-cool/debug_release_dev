...
public class RefreshListLayout extends ViewGroup {
    private static final String TAG = "RefreshListLayout";
    ...
    private RefreshListLayout.AutoScroll autoScroll;
    private State state = State.RESET;
    private RefreshListLayout.OnRefreshListener refreshListener;
    ...
    public RefreshListLayout(Context context, AttributeSet attrs) {
        ...
        autoScroll = new RefreshListLayout.AutoScroll();
    ...
    public void setRefreshListener(RefreshListLayout.OnRefreshListener refreshListener) {
